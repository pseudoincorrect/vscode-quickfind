...
export function activate(context: vscode.ExtensionContext) {
  ...
  const searchInFileCommand = vscode.commands.registerCommand(
    "quickFind.searchInFile",
    () => {
  ...
  const searchFilesCommand = vscode.commands.registerCommand(
    "quickFind.searchFiles",
    () => {
  ...
  const historyPreviousCommand = vscode.commands.registerCommand(
    "quickFind.historyPrevious",
    () => {
      if (activeQuickFindPanel) {
        activeQuickFindPanel.webview.postMessage({
  ...
  const historyNextCommand = vscode.commands.registerCommand(
    "quickFind.historyNext",
    () => {
      if (activeQuickFindPanel) {
